...
{
    category: string
    colorsMap: StringMap<PaletteColor>
    hexes: HexCollection
}[]
    = [
        {
            category: 'black',
            colorsMap: BLACK_PALETTE_COLORS,
            hexes: BLACK_HEXES
        },
        {
            category: 'blue',
            colorsMap: BLUE_PALETTE_COLORS,
            hexes: BLUE_HEXES
        },
        {
            category: 'brown',
            colorsMap: BROWN_PALETTE_COLORS,
            hexes: BROWN_HEXES
        },
        {
            category: 'gray',
            colorsMap: GRAY_PALETTE_COLORS,
            hexes: GRAY_HEXES
        },
        {
            category: 'green',
            colorsMap: GREEN_PALETTE_COLORS,
            hexes: GREEN_HEXES
        },
        {
            category: 'pink',
            colorsMap: PINK_PALETTE_COLORS,
            hexes: PINK_HEXES
        },
        {
            category: 'purple',
            colorsMap: PURPLE_PALETTE_COLORS,
            hexes: PURPLE_HEXES
        },
        {
            category: 'red',
            colorsMap: RED_PALETTE_COLORS,
            hexes: RED_HEXES
        },
        {
            category: 'white',
            colorsMap: WHITE_PALETTE_COLORS,
            hexes: WHITE_HEXES
        }
    ];

describe.each(COLOR_CATEGORIES)(
